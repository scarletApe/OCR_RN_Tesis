 ...
 * @author juanmartinez
 */
public class TesterNegationProblem {
    ...
    public static void main(String[] args) {
        ...
        RedNeuronal red = new RedNeuronal("Red Negacion");
        red.crearRed(4, new int[]{8}, 3, new FuncionSigmoidea());
//        red.entrenarRed(entrada, salida, 0.1, 15000);
        red.entrenarRed(entrada, salida, 0.5, 0.01);//learning rate 0.1
